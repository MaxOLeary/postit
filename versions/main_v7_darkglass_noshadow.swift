...
// MARK: - A borderless window that can still take the keyboard
...
final class AppDelegate: NSObject, NSApplicationDelegate, NSTextViewDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        // subtle blue — low alpha so it stays calm even when focused
        glass.tintColor = NSColor(calibratedRed: 0.30, green: 0.52, blue: 0.85, alpha: 0.12)
